...
class ImHistoryCommand extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this->setHelp(<<<EOT
The <info>slack:im:history</info> command returns a portion of messages/events from the specified im.
...
all messages in a hole in im history, by running the <info>slack:im:history</info> command with `--latest`
